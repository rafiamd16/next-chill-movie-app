...
const genre1 = ['Aksi', 'Anak-anak', 'Anime', 'Britania']
const genre2 = ['Drama', 'Fantasi Ilmiah & Fantasi', 'Kejahatan', 'KDrama']
const genre3 = ['Komedi', 'Petualangan', 'Perang', 'Romantis']
const genre4 = ['Sains & Alam', 'Thriller']
...
const DesktopFooter = () => {
  return (
    <div className='flex flex-wrap items-center justify-between gap-8'>
      <div className='space-y-[26px] flex-1'>
      ...
      <div className='flex items-center justify-between gap-40'>
        ...
        <div className='space-y-4 text-base'>
          ...
          <div className='flex justify-between gap-7'>
            <ul className='space-y-4 text-[#C1C2C4]'>
              {genre1.map((genre, i) => (
