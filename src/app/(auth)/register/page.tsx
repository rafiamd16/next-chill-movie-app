...
const RegisterPage = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-[url(/img/bg-register.png)] bg-cover bg-center'>
      <div className='w-[306px] md:w-[529px] bg-[#181A1CD6] px-6 py-4 md:px-10 md:py-8 flex items-center flex-col gap-2 md:gap-4 rounded-[8px] md:rounded-2xl'>
        ...
        <div className='space-y-2'>
          <h2 className='font-bold text-lg md:text-[32px] text-center'>Daftar</h2>
          <p className='text-[10px] md:text-base'>Selamat datang!</p>
        </div>
        <RegisterForm />
      </div>
    </div>
